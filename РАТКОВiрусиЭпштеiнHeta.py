...
# Для получения полной информации о лицензии, пожалуйста, посетите:
# https://opensource.org/licenses/MIT
#
# Запрещается любое несанкционированное изменение или распространение.
# =========================================================================
# Модуль: ВiрусFHeta
# Разработан Мофкой (@pupozermofko)
# © 2024-2029
#
...
#
# Если вы модифицируете этот файл, пожалуйста, укажите это явно.
# =========================================================================
# ╔═════════════════════════════════════════════════════════════════════╗
# ║ Модуль: ВiрусFHeta                                                    ║
# ║ Автор: Мофка (@pupozermofko)                                          ║
# ║ © Copyright 2024-2029.                                                ║
# ║                                                                       ║
# ║ Данный код распространяется под лицензией GNU General Public License v3.0. ║
# ║ Полный текст лицензии: https://www.gnu.org/licenses/agpl-3.0.html     ║
# ║                                                                       ║
# ║ Изменения без разрешения автора запрещены.                            ║
# ╚═════════════════════════════════════════════════════════════════════╝
# Модуль: ВiрусFHeta
# Copyright (c) 2024-2029 Мофка (@pupozermofko)
# Все права защищены.
#
# Распространение и использование в исходной и бинарной форме,
# с изменениями или без них, разрешается при условии соблюдения
# BSD 3-Clause License.
# Подробности: https://opensource.org/licenses/BSD-3-Clause
# -------------------------------------------------------------------------
# Проект: ВiрусFHeta
# Автор: Мофка
# Контакт: @pupozermofko
# Год: 2024-3900
#
# Лицензия: ISC License
# Разрешается использование, копирование, изменение и/или распространение
# этого программного обеспечения для любых целей с или без взимания платы,
# при условии, что вышеуказанное уведомление об авторских правах и
# это разрешение появляются во всех копиях.
# Полная лицензия: https://opensource.org/licenses/ISC
# -------------------------------------------------------------------------
# ВiрусFHeta
#
# Автор: Мофка (@pupozermofko)
# Дата: 2024-2100
#
# Этот код является свободным и несвязанным программным обеспечением,
# выпущенным в общественное достояние.
# Подробности: http://unlicense.org/
# =========================================================================
# Модуль: ВiрусFHeta
# Владелец: Мофка (@pupozermofko)
# © 2024-2029. Все права защищены.
#
# Это проприетарное программное обеспечение.
# Несанкционированное изменение, распространение или воспроизведение строго
# запрещено без явного письменного разрешения от Мофки.
# Контакты для запросов: @pupozermofko
# =========================================================================
# ╭───────────────────────────────────────────────────────────────────────╮
# │ Модуль: ВiрусFHeta                                                    │
# │ Автор: Мофка (@pupozermofko)                                          │
# │ © 2024-2029                                                           │
# │                                                                       │
# │ Этот исходный код распространяется под лицензией Mozilla Public License, v. 2.0. │
# │ Если копия MPL не была распространена с этим файлом, вы можете получить её по адресу: │
...
# # Работа посвящена общественному достоянию.                             #
# # Подробности: https://creativecommons.org/publicdomain/zero/1.0/      #
# #########################################################################
# +-----------------------------------------------------------------------+
# | Модуль: ВiрусFHeta                                                    |
# | Автор: Мофка (@pupozermofko)                                          |
...
# | Версия: 1.0.0                                                         |
# |                                                                       |
# | Пользовательская лицензия Мофки                                       |
# | Это программное обеспечение предоставляется "КАК ЕСТЬ", без каких-либо |
# | явных или подразумеваемых гарантий. Использование на ваш страх и риск. |
# | Все права на код принадлежат Мофке. Несанкционированное копирование, |
# | изменение или распространение без разрешения запрещено.              |
# | Для получения разрешений: @pupozermofko                               |
# +-----------------------------------------------------------------------+
# Модуль: ВiрусFHeta
# Copyright (c) 2024-2029 Мофка
# t.me/pupozermofko
# Лицензия: Custom Open-Source Friendly by Мофка
# Вы можете использовать, модифицировать и распространять этот код,
# при условии сохранения данного уведомления об авторских правах
# и указания ссылки на автора.
# Для коммерческого использования требуется согласование.
# ─────────────────────────────────────────────────────────────────────────
# Модуль: ВiрусFHeta
# © 2024-2029 Мофка (@pupozermofko)
#
# Этот код предназначен для личного некоммерческого использования.
